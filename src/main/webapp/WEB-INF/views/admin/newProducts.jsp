...
<body>
											...
											<div class="col-sm-8">
												...
												<form action="check_admin.jsp">
													<label>User Name:</label> <input type="text"
														class="form-control" name="name"> <label>Password:</label>
	...
	<marquee>These all the products are added by the vendors and
		not displaying yet on the Shoppee World home page,add them all to the
		website to display them on the Shoppe World </marquee>
				...
				<tbody>
					<c:forEach var="product" items="${products}">
						<tr>
							...
							<td><a href="allow.jsp?id=${product.id}">Allow</a></td>
							<td><a href="Disallow.jsp?id=${product.id}">Disallow</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
