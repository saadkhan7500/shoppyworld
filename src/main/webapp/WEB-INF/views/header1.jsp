 ...
 <%-- <%!
  ...
  <!-- Navbar starts here -->
					 ...
					 <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top ">
					  <a class="btn btn-outline-danger" href="index1.jsp"><i style="font-size:26px" class="fab fa-speakap"></i> Shoppe Hub</a>&nbsp
					    <a class="btn btn-outline-info" href="profile.jsp"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> ${vendor.name}</a>
